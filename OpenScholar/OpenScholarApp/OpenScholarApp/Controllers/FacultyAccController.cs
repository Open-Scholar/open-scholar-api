...
namespace OpenScholarApp.Controllers
{
    ...
    [ApiController]
    public class FacultyAccController : BaseController
    {
        private readonly IFacultyAccService _facultyService;
        private readonly UserManager<ApplicationUser> _userManager;

        public FacultyAccController(IFacultyAccService facultyService, UserManager<ApplicationUser> userManager)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateFaculty([FromBody] AddFacultyAccDto facultyDto)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateFaculty(int id, [FromBody] UpdateFacultyAccDto updatedFacultyDto)
        {
            try
            {
